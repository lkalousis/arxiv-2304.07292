...
To evade this difficulty we calculated the first PE peak\footnote{That is ($S(x)*B$)(x).} numerically and the higher PE peaks were approximated with symmetric gaussians. 
