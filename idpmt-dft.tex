...
\abstract{The purpose of the present article is to demonstrate the calibration of photomultiplier tubes with gaussian single photoelectron response using a numerical method based on the Discrete Fourier Transform (DFT). 
...
This scheme was applied to calibration of the Hamamatsu R7081 photomultiplier tube and toy Monte Carlo data. 
