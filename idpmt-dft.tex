...
Series of several toy Monte Carlo SPE data were generated. 
The algorithm that was followed to produce these spectra can be summarized in the following steps
\begin{enumerate}[i.]
\item First, a number of photoelectrons, $n$, was thrown 
\item
\end{enumerate}
